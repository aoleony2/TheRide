...
**Github:** https://github.com/CSC301H5/finalprojectw23-theride
...
## proposal.md (Max 8 marks)
  ...
  summary.md Total Mark: 10 / 16

  I think that the idea has potential, but can be further refined. It seems that at the moment the idea lacks technical complexity as it seems like a simple marketplace idea. There seem to be academic offence issues that haven’t exactly been addressed. Also what stops users from just directly contacting the tutors? Why should people go through this platform? Principles were not defined. Also, more could've been said about whether or not there are competing apps that do what you do.
...
## competition.md (Max 2 marks)
  ...
  Some examples of other third party apps would be helpful here.
...
## Product Backlog PB.md (Max 8 marks) 
  ...
  To make a line break in markdown, you should add two line breaks.
...
## Definition of done: done.md (max 2 marks)
  ...
  Misunderstanding the point of done.md. done.md is supposed to be a general definition of "done" for all user stories (PR is merged, code is tested, etc)
...
## Process: process.md (max 10 marks)
  ...
  Single line breaks don't work in markdown. 
