...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - CRC Cards [or equivalent, if the team is not using CRC) (max 4 marks)
    ...
    Your Mark: 3 
    - some cards don't have appropriate collaborators 
...
## Sprint Demo (Max 14 marks) 
  ...
  - Presentation (max 2 marks)
    ...
    - x1 mark = one or more errors identified by the demo TA
  ...
  -> -0.5 for front-end documentation, -0.5 for back-end documentation
  Your Mark: 13 / 14
